                    ...
                    <li>
                        ...
                        >
                            <span className="relative z-1 block h-10 w-full max-w-10 rounded-full">
                                <span className="flex h-full w-full items-center justify-center rounded-full bg-brand-100 text-brand-600 dark:bg-brand-500/20 dark:text-brand-400">
                                    <svg
                                        width="16"
                                        height="16"
                                        viewBox="0 0 20 20"
                                    ...
                                    >
                                        <path
                                            d="M10 2C5.58 2 2 5.58 2 10s3.58 8 8 8 8-3.58 8-8-3.58-8-8-8zm0 14.5c-3.58 0-6.5-2.92-6.5-6.5S6.42 3.5 10 3.5s6.5 2.92 6.5 6.5-2.92 6.5-6.5 6.5z"
                                            fill="currentColor"
                                        />
                                    </svg>
                                </span>
