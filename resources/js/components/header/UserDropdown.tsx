...
export default function UserDropdown() {
    ...
    return (
        <div className="relative">
            ...
            >
                <span className="mr-3 flex h-11 w-11 items-center justify-center overflow-hidden rounded-full bg-gray-200">
                ...
                <span className="mr-1 flex flex-col items-start">
                    <span className="block text-theme-sm leading-tight font-medium">
                        {displayName}
                    </span>
            ...
            >
                ...
                {showBranchSwitcher && (
                    <div className="border-b border-gray-200 pt-3 pb-3 dark:border-gray-800">
