...
export default function Edit({ product, categories, uoms, availableProducts = [] }: Props) {
    ...
    const form = useForm<ProductForm>({
        ...
        uom_id: product.uom_id ?? uoms[0]?.id ?? 0,
        ...
        is_inventory_tracked: product.is_inventory_tracked ?? true,
        min_stock: product.min_stock ?? 0,
        inventory_account_id: product.inventory_account_id ?? null,
        is_active: product.is_active ?? true,
        bundle_items:
            product.bundle_items?.map((i) => ({
            ...
            <div className="space-y-6 pb-12">
                ...
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <h1 className="text-2xl font-bold text-slate-900">Edit produk: {product.name}</h1>
                    </div>
                </div>
