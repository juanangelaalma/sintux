...
export default function PurchaseInvoicesCreate({ branches, suppliers, productVariants, warehouses = [] }: Props) {
            ...
            <div className="space-y-6">
                ...
                <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-slate-200 pb-4">
                    <div>
                        ...
                        <h1 className="text-2xl font-bold text-slate-900">Buat Faktur Pembelian (Invoice)</h1>
                    </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6 bg-white p-6 rounded-xl border border-slate-200 shadow-sm">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-4 text-sm">
                        ...
                        <div className="md:col-span-2">
                            <label className="block text-xs font-semibold text-slate-700">Alamat Penagihan</label>
                            <textarea
                                rows={2}
                        ...
                        <div className="space-y-3">
                            <div>
                                <label className="block text-xs font-semibold text-slate-700">Tgl. faktur *</label>
                                <input
                                    type="date"
